...
{
    /// <summary>
    /// 需要一个类作为中介,将Editor的逻辑与窗体剥离
    /// 其他类需要和Form交互的时候,统一交互Controller,
    /// Form点击的时候,产生一个事件,由Controller来相应这个事件
    /// Controller在初始化的时候,将自己的方法绑定在Form的事件上面
    /// </summary>
    ...
    { 
        ...
        public GameObject CurrertGameObject
        {
            get
            {
                return EditorSystem.CurrertGameObject;
            }
            set
            {
                EditorSystem.CurrertGameObject = value;
            }
        }
