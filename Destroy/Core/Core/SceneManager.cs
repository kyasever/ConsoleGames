namespace Destroy
{
    ...
    public static class SceneManager
    {
        ...
        internal static DontDestroyOnLoad DontDestroyOnLoadScene { get; set; }
        ...
        public static void Init()
        {
            ...
            DontDestroyOnLoadScene = new DontDestroyOnLoad();
        ...
        {
            if (!SceneManager.DontDestroyOnLoadScene.GameObjects.Contains(gameObject))
                gameObject.AddToScene(SceneManager.DontDestroyOnLoadScene);
