namespace Destroy
{
    ...
    public class Config
    {
        ...
        /// 游戏打开的面板大小
        /// </summary>
        public static Vector2 WindowsSize
        {
            get
            {
                return new Vector2(Config.ScreenWidth * (int)Config.CharWidth * Config.RendererSize.X / 2, Config.ScreenHeight * Config.RendererSize.Y);
