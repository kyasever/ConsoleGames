namespace Destroy.Standard
{
    ...
    public static class TPSFactroy
    {
        ...
        public static GameObject CreateBox(Vector2 pos)
        {
            ...
            {
                case 0:
                    box.InitMesh(new List<Vector2>() { new Vector2(0, 0), new Vector2(1, 0), new Vector2(2, 0), new Vector2(0, -1) });
                    break;
                case 1:
                    box.InitMesh(new List<Vector2>() { new Vector2(0, 0), new Vector2(1, 0), new Vector2(0, 1), new Vector2(1, -1) });
                    break;
                case 2:
                    box.InitMesh(new List<Vector2>() { new Vector2(0, 0), new Vector2(1, 0), new Vector2(2, 0), new Vector2(3, 0) });
                    break;
                case 3:
                    box.InitMesh(new List<Vector2>() { new Vector2(0, 0), new Vector2(1, 0), new Vector2(-1, 0), new Vector2(0, 1) });
                    break;
                default:
                    break;
            }
